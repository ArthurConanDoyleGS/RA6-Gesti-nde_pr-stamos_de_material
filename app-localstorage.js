...
function renderizarPrestamos() {
    if (prestamos.length === 0) {
        ...
        contadorPrestamos.textContent = "0 préstamos registrados";
        return;
    }
    ...
    contadorPrestamos.textContent = `${prestamos.length} préstamo${prestamos.length === 1 ? "" : "s"} registrado${prestamos.length === 1 ? "" : "s"}`;
}
...
function cargarPrestamoEnFormulario(indice) {
    ...
    tituloFormulario.textContent = "Editar préstamo";
    botonGuardar.textContent = "Actualizar préstamo";
...
function reiniciarFormulario() {
    ...
    indiceEdicion = null;
    tituloFormulario.textContent = "Nuevo préstamo";
